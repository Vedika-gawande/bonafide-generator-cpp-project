...
if (!file_exists($logoPath) || !file_exists($signPath) || !file_exists($stampPath)) {
    die(json_encode(["message" => "One or more images missing!"]));
}

// Add images
$pdf->Image($logoPath, 25, 20, 60, 40);

// Move text closer to the logo
$pdf->SetXY(140, 30);
$pdf->SetFont('Times', 'B', 20);
$pdf->Cell(0, 10, 'GOVERNMENT POLYTECHNIC YAVATMAL', 0, 1, 'L');
$pdf->Ln(3);
$pdf->SetFont('Times', '', 16);
$pdf->SetX(160);
$pdf->Cell(0, 11, 'DHAMANGAON ROAD, YAVATMAL 445001', 0, 1, 'L');
$pdf->SetX(120);
...
$pdf->MultiCell(350, 12, 
    ...
    $request['year'] . "  of the diploma course in " . $request['branch'] . 
...
$pdf->MultiCell(350, 12, 
    ...
    $request['reason'] . " as per  application dated " . 
